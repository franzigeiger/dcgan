...
def get_discriminator(pretrained=True):
    ...
    if pretrained:
        ...
        if torch.cuda.is_available():
            D.load_state_dict(torch.load(f'{dir_path}/weights/netD_epoch_199.pth'))
        else:
            D.load_state_dict(torch.load(f"{dir_path}/weights/netD_epoch_199.pth", map_location='cpu'))
    return D
